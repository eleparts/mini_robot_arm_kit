...
* 제작 : eleparts 부설연구소
* SW ver. 1.31
* Servo 모터 4개 + 조이스틱(analog data) + SW 4개 제어 + 보조기능 평행이동 / 기억-실행
**************************************************************/
#include <Servo.h>
...
void loadMovement(int moveDataCnt){
  ...
  {
    Hand.write(angleDataBae[moveCnt][0]);
    ArmTop.write(angleDataBae[moveCnt][1]);
    ArmBot.write(angleDataBae[moveCnt][2]);
    Prop.write(angleDataBae[moveCnt][3]);
